 ...
 *
 *
 * @Autowired 的作用范围：构造器，方法，参数，属性  [com.wyw.spring.annotation.ioc.entity.Thor]
 *  作用在方法上，spring容器创建当前对象时会调用方法，完成赋值，
 *  方法使用的参数如果是自定义类型，值从ioc容器中获取
 *  使用@Bean注册组件，方法参数的值也会从ioc容器中获取(@AutoWired可省略),默认不写 [com.wyw.spring.annotation.ioc.MainConfigOfAutowired#getRogers(com.wyw.spring.annotation.ioc.entity.Hammer)]
 *
 ...
 *  原理：使用XXXProcessor处理
 *  [com.wyw.spring.annotation.ioc.entity.Rogers]
 *
 * @author wyw
 * @date 2020/06/19
 */
